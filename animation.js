...
class Particle {
    ...
    update() {
        // Verifica se a partícula está perto do mouse
...
function fecharModal() {
  const modal = document.getElementById('map-modal');
  modal.style.display = 'none'; // Esconde novamente
}

// Fecha se clicar fora da janelinha (no fundo preto)
